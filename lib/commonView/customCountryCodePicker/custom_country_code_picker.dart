...
class CustomCountryCodePickerState extends State<CustomCountryCodePicker> {
              ...
              if (widget.showFlagMain != null ? widget.showFlagMain! : widget.showFlag)
                Flexible(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(selectedItem!.flagUri!, width: widget.flagWidth),
                  ),
                ),
              ...
              if (widget.showDropDownButton)
                Flexible(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.arrow_drop_down, color: Colors.grey, size: widget.flagWidth),
                  ),
                ),
            ],
          ),
  ...
  void showCountryCodePickerDialog() {
    showDialog(
      barrierColor: widget.barrierColor ?? getCurrentTheme(context).colorBlack.withValues(alpha: 0.05),
      // backgroundColor: widget.backgroundColor ?? Colors.transparent,
      context: context,
      builder:
          (showCountryCodePickerDialogContext) => Center(
            child: Dialog(
              child: SelectionDialog(
                ...
                backgroundColor: widget.dialogBackgroundColor ?? getCurrentTheme(context).colorCountryCodePickerSelectionDialogBG,
