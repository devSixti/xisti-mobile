...
class AppThemeColors extends ThemeExtension<AppThemeColors> {
  // Official XISTI palette — see XistiBrand in lib/utils/xisti_ui_tokens.dart
  static const Color brandGreen = Color(0xFF80FF00);
  static const Color brandPurple = Color(0xFF681FFF);
  static const Color brandPurpleMedium = Color(0xFF8251FC);
  static const Color brandPurpleDeep = Color(0xFF3800C1);
  static const Color brandGreenVibrant = Color(0xFF74D603);
  static const Color brandBlack = Color(0xFF000000);
  static const Color brandSurfaceDark = Color(0xFF1A1A1A);
  ...
  AppThemeColors.light({
    ...
    Color colorPrimary = const Color(0xFF80FF00),
    Color colorWalletBgGradient1 = const Color(0xFF80FF00),
    Color colorWalletBgGradient2 = const Color(0xFF681FFF),
    Color? colorSelectionPrimaryOpc = const Color(0x3380FF00),
    ...
    Color? colorBtnGradient1 = const Color(0xFF80FF00),
    Color? colorBtnGradient2 = brandGreenVibrant,
    ...
    Color? colorRating = const Color(0xFF80FF00),
    ...
    Color? colorPsRunningIconBg = const Color(0xFF80FF00),
    ...
    Color? colorStatusOnGoing = const Color(0xFF681FFF),
    Color? colorReferralPending = const Color(0xFF681FFF),
    ...
    Color? colorSplashGradient1 = brandGreen,
    Color? colorSplashGradient2 = brandGreenVibrant,
  }) {
    _systemUiOverlayStyle = SystemUiOverlayStyle(
  ...
  AppThemeColors.dark({
    ...
    Color? colorWhite = brandSurfaceDark,
    Color? colorAppBarDefault = brandSurfaceDark,
    Color? colorPreferencesChoiceChipBg = const Color(0xFF141414),
    Color colorPrimary = const Color(0xFF80FF00),
    Color colorWalletBgGradient1 = const Color(0xFF80FF00),
    Color colorWalletBgGradient2 = brandPurpleMedium,
    Color? colorDarkIconCommon = const Color(0xFFE5E7EB),
    Color? colorBlack = const Color(0xFFF9FAFB),
    Color? colorScaffoldBg = brandSurfaceDark,
    ...
    Color? colorRippleAnimation = const Color(0xFF80FF00),
    Color? colorRippleAnimationBg = const Color(0xB31A1A1A),
    Color? colorDriverStatusContainerBg = const Color(0xFF1F2937),
    Color? colorOfflineContainerRed = const Color(0xFFFF0051),
    Color? colorOnlineContainerGreen = const Color(0xFF80FF00),
    Color? colorActiveOfflineText = brandBlack,
    Color? colorActiveOnlineText = brandBlack,
    Color? colorInActiveOnlineText = brandBlack,
    Color? colorContainerBorder = const Color(0xFF681FFF),
    ...
    Color? colorRating = const Color(0xFF80FF00),
    Color? colorHailIcon = brandBlack,
    Color? colorProgressBtnBg = const Color(0xFF374151),
    Color? colorAvailableDriverBg = const Color(0xE61A1A1A),
    Color? colorAvailableDriverBorder1 = const Color(0x8080FF00),
    Color? colorAvailableDriverBorder2 = const Color(0x33681FFF),
    Color? colorAvailableDriverCardBg = const Color(0x33141414),
    Color? colorPsRunningIcon = brandBlack,
    Color? colorPsRunningIconBg = const Color(0xFF80FF00),
    ...
    Color? colorStatusCompleted = const Color(0xFF80FF00),
    Color? colorReferralClaimed = const Color(0xFF80FF00),
    Color? colorCountryCodePickerSelectionDialogBG = const Color(0xFF141414),
    Color? colorKmAndTimeText = const Color(0xFF9CA3AF),
    Color? colorSuggestionAmountAndIcon = brandBlack,
    Color? colorOfferEditIcon = const Color(0xFFF3F4F6),
    Color? colorBackGroundWaiting = brandSurfaceDark,
    Color? colorCreditIcon = const Color(0xFF80FF00),
    Color? colorDebitIcon = const Color(0xFFFF0051),
    Color? colorIssueResolved = const Color(0xFF80FF00),
    Color? colorIssueUnResolved = const Color(0xFFFF0051),
    Color? colorGreen = const Color(0xFF80FF00),
    Color? colorSplashGradient1 = const Color(0xFF80FF00),
    Color? colorSplashGradient2 = const Color(0xFF681FFF),
  }) {
    _systemUiOverlayStyle = SystemUiOverlayStyle(
      statusBarColor: Colors.transparent,
