...
class ItemPassengerRideHistory extends StatelessWidget {
  final PassengerRideListItem item;

  const ItemPassengerRideHistory({super.key, required this.item});

  @override
  Widget build(BuildContext context) {
    debugPrint("my order status in item : ${item.rideId} : ${item.rideStatus}");
    return Column(
      children: [
        // Date and Cost
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                getAmountWithCurrency(item.totalPay),
        ...
        Row(
          ...
          children: [
            ...
            // Status
            PassengerRideStatusView(rideStatus: item.rideStatus),
          ],
        ),
      ],
    );
